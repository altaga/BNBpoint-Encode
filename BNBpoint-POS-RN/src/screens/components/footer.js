      ...
      <View
        style={[
          GlobalStyles.footer,
          {
            ...
            alignItems: "center",
            borderTopWidth: 2,
            borderColor: headerColor[this.context.value.networkSelected],
          },
        ]}
      >
        <Pressable
        ...
        >
          ...
          {this.context.value.selected === 1 && (
            <Text style={[GlobalStyles.buttonText]}>Crypto</Text>
          )}
        </Pressable>
        <Text style={[GlobalStyles.buttonText]}>|</Text>
        <Pressable
        ...
        >
          ...
          {this.context.value.selected === 2 && (
            <Text style={[GlobalStyles.buttonText]}>Ewallet</Text>
          )}
        </Pressable>
      </View>
    );
