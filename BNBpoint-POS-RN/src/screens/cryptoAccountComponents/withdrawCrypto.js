...
import {contentColor, headerColor, NODE_ENV_NETWORK_RCP} from "../../../env"
            ...
            <View style={GlobalStyles.container}>
                <Header />
                {
                    <View style={{ position: "absolute", top: 9, left: 18 }}>
                        <Pressable onPress={() => this.props.navigation.navigate('CryptoAccount')}>
                            <IconMCI name="arrow-back-ios" size={36} color={headerColor[this.context.value.networkSelected]} />
                        </Pressable>
                    </View>
                }
                {
                ...
                }
                {
                    ...
                    <View style={[GlobalStyles.mainSub, { flexDirection: "column", justifyContent: "space-evenly", alignItems: "center" }]}>
                        ...
                        <View style={{ borderBottomWidth: 2, borderColor: contentColor[this.context.value.networkSelected], width: "90%" }} />
                ...
                }
                {
                    this.state.stage === 4 &&
                    <View style={[GlobalStyles.mainSub, { flexDirection: "column", justifyContent: "space-evenly", alignItems: "center" }]}>
                        <Icon2 name="check-circle" size={240} color={contentColor[this.context.value.networkSelected]} />
                        <Text style={{
                            textShadowRadius: 1,
                        ...
                        <Pressable style={{ marginVertical: 30 }} onPress={() => Linking.openURL(`${NODE_ENV_EXPLORER[this.context.value.networkSelected]}tx/` + this.state.hash)}>
                            <Text style={{
