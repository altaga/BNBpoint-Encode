...
import { contentColor, native } from '../../../env';
            ...
            <ScrollView>
                {this.props.transactions.map((item, index) => (
                    <View key={index} style={{
                        ...
                        <View style={{
                            ...
                            <View>
                                <Text style={{ fontSize: 18, textAlign: "center", color: "white" }}>
                                    ...
                                    {"  "}
                                    {
                                        item.tokenSymbol !== undefined ? item.tokenSymbol : native[this.context.value.networkSelected]
                                    }
                                </Text>
                            </View>
                        ...
                        <View style={{ backgroundColor: contentColor[this.context.value.networkSelected], height: 1, width: "90%", marginVertical: 20, alignSelf:"center" }} />
                    </View>
                ))
                }
            </ScrollView>
