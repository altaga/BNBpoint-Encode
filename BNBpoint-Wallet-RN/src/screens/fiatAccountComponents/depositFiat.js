            ...
            <>
                <View style={GlobalStyles.container}>
                    ...
                    <View style={[GlobalStyles.mainSub, { flexDirection: "column", justifyContent: "space-evenly", alignItems: "center" }]}>
                        ...
                        <View style={{ borderColor: contentColor[this.context.value.networkSelected], borderWidth: 2 }}>
                            <QRCode
                        ...
                        <View style={[{ flexDirection: "row", alignItems: "center" }]}>
                            ...
                            <Pressable
                                ...
                                <IconMC name="content-copy" size={24} color={contentColor[this.context.value.networkSelected]} />
                            </Pressable>
                        </View>
                        <Pressable style={[GlobalStyles.button,{backgroundColor:contentColor[this.context.value.networkSelected]}]} onPress={() => this.props.navigation.navigate('FiatAccount')}>
