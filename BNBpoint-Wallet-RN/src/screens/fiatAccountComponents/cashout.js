            ...
            <View style={{height: '60%'}}>
              <ScrollView>
                <View style={{justifyContent: 'center', alignItems: 'center'}}>
                  <Text
                    style={{color: 'white', fontSize: 30, marginVertical: 10}}>
                    Spei Transfer
                  </Text>
                  ...
                  />
                  <Text style={{color: 'white', fontSize: 24}}>CLABE</Text>
                  <TextInput
                    style={{
                      width: Dimensions.get('window').width * 0.9,
                      borderRadius: 5,
                  ...
                  />
                  <Text style={{color: 'white', fontSize: 24}}>Amount USD</Text>
                  <TextInput
                    style={{
                      width: Dimensions.get('window').width * 0.9,
                      borderRadius: 5,
                    ...
                    onChangeText={text => {
                      if (
                        ...
                        if (text === '') {
                          ...
                          if (
                            parseFloat(text) >=
                            parseFloat(this.context.value.ewalletBalance)
                          ) {
                            this.mount &&
                              this.setState({
                                amount: parseFloat(
                                  this.context.value.ewalletBalance,
                                ).toString(),
                              });
                          } else {
                            this.mount &&
