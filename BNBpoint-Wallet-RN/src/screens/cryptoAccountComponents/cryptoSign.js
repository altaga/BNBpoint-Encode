...
class CryptoSign extends Component {
    ...
    checkBiometrics() {
        this.biometrics.simplePrompt({ promptMessage: 'Confirm fingerprint' })
                    ...
                    try {
                        try {
                            ...
                            if (session !== null) {
                                ...
                                this.web3.eth.accounts.signTransaction(this.props.transaction, JSON.parse(session).value.privateKey).then((res) => this.props.signTrans(res)).catch((error) => console.log(error))
                            }
                            else {
                                // nothing
                            }
