    ...
    return (
      <View style={GlobalStyles.containerSetup}>
        ...
        {this.state.stage === 2 && (
          <>
            ...
            <Text
              ...
              Protect your Wallet{'\n'}with a pincode
              {this.state.biometric && ' and biometrics'}
            </Text>
            <Pressable
              style={[
                GlobalStyles.button,
          ...
          <>
            ...
            {this.state.biometric && (
              <Pressable
                ...
                onPress={() => this.storeUserBiometrics()}>
        ...
        {this.state.stage === 5 && (
          <>
            <Text
              style={[GlobalStyles.simpleText, {fontSize: 20, width: '80%'}]}>
        ...
        {this.state.stage === 6 && (
          <>
            <Text
              style={[
                GlobalStyles.simpleText,
                {fontSize: 22, width: '80%', marginBottom: 20},
              ]}>
              KYC form
            </Text>
            <View
            ...
            <ScrollView style={{width: '100%'}}>
              <View
                ...
                <Text
                  style={[
                    GlobalStyles.simpleText,
                    {fontSize: 22, width: '90%', marginTop: 10},
                  ]}>
                  Name
                </Text>
                <TextInput
                ...
                <View
                  ...
                  <TextInput
                    ...
                    value={
                      this.state.form.date === undefined
                        ? ''
                ...
                <View
                  ...
                  <Text
                    style={[
                      GlobalStyles.simpleText,
                      {fontSize: 22, width: '20%', color: 'white'},
                    ]}>
              ...
              <Pressable
                ...
                <Text style={[GlobalStyles.buttonText]}>Complete KYC</Text>
              </Pressable>
            </ScrollView>
          </>
        )}
