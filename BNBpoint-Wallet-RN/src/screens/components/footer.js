...
class Footer extends Component {
    ...
    render() {
        return (
            <View style={[GlobalStyles.footer, { flexDirection: "row", justifyContent: "space-evenly", alignItems: "center", borderTopWidth: 2, borderColor: headerColor[this.context.value.networkSelected] }]}>
                <Pressable style={[
            this.context.value.selected === 0
              ? [
                  GlobalStyles.buttonFooterSelected,
                  {
                    backgroundColor:
                      headerColor[this.context.value.networkSelected],
                  },
                ]
              : [GlobalStyles.buttonFooter, {}]
          ]} onPress={() => {
                ...
                <Text style={[GlobalStyles.buttonText, { color: headerColor[this.context.value.networkSelected]}]}>
                    |
                </Text>
                <Pressable style={[
