                    ...
                    <Header />
                    {
                        this.context.value.ewallet === "" ?
                            ...
                            <View style={[GlobalStyles.main, { flexDirection: "column", alignItems: "center", paddingTop: 10 }]}>
                                ...
                                <Text style={{ textAlign: "center", color: "white", fontSize: 30 }}>
                                    {
                                        this.state.flag ? "USD" : native[this.context.value.networkSelected]
                                    }
                                </Text>
                                <TextInput
                                    style={{ fontSize: 24, textAlign: "center", borderRadius: 6, backgroundColor: 'white', color: "black", width: "100%", marginVertical: 20, borderWidth: 1, borderColor: contentColor[this.context.value.networkSelected] }}
                                ...
                                />
                                <Pressable style={{ width: 40, height: 40, backgroundColor: contentColor[this.context.value.networkSelected], borderRadius: 100, alignItems: "center", justifyContent: "center" }} onPress={() => {
                                ...
                                <Text style={{ textAlign: "center", color: "white", fontSize: 30 }}>
                                    {
                                        this.state.flag ? native[this.context.value.networkSelected] : "USD"
                                    }
                                </Text>
                            </View>
                    }
